  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <h1 className="text-2xl sm:text-3xl font-semibold text-white">Enrollment Management</h1>
              ...
              {enrollments.length === 0 ? (
                ...
                enrollments.map((enrollment) => (
                  <div
                    ...
                    className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-lg border border-white/10 p-4"
                  >
