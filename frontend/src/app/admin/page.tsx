...
export default function AdminDashboardPage() {
  ...
  if (!analytics) {
    return <div className="p-8 text-white">Failed to load analytics</div>;
  }
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">Manage users, courses, and system analytics</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-5">
        <Card className="border-white/10 bg-white/5">
          <CardHeader>
            ...
            <CardTitle className="text-4xl text-white">{analytics.totals.users}</CardTitle>
          </CardHeader>
        </Card>
        <Card className="border-white/10 bg-white/5">
          <CardHeader>
            <CardDescription>Students</CardDescription>
            <CardTitle className="text-4xl text-white">{analytics.totals.students}</CardTitle>
          </CardHeader>
        </Card>
        <Card className="border-white/10 bg-white/5">
          <CardHeader>
            <CardDescription>Teachers</CardDescription>
            <CardTitle className="text-4xl text-white">{analytics.totals.teachers}</CardTitle>
          </CardHeader>
        </Card>
        <Card className="border-white/10 bg-white/5">
          <CardHeader>
            <CardDescription>Courses</CardDescription>
            <CardTitle className="text-4xl text-white">{analytics.totals.courses}</CardTitle>
          </CardHeader>
        </Card>
        <Card className="border-white/10 bg-white/5">
          <CardHeader>
            <CardDescription>Total Enrollments</CardDescription>
            <CardTitle className="text-4xl text-white">{analytics.totals.enrollments || 0}</CardTitle>
          </CardHeader>
        </Card>
      </div>
